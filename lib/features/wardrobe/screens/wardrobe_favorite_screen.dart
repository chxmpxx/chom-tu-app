                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                      ...
                      child: IconButton(
                        onPressed: (){},
                        icon: SvgPicture.asset('assets/icons/o2_heart_2.svg')
                      ),
                    ),
                  ],
                ),
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            InkWell(
              onTap: () {},
              child: const FilterBarWidget(title: 'Sort', status: false)
            ),
            InkWell(
              onTap: () {},
              child: const FilterBarWidget(title: 'Color', status: false)
            ),
          ],
        ),
      ),
